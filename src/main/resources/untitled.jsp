			...
			<div class="container">
				...
				<div id="cart_links">
					<ul>
						...
						<li><a href="<s:url value="page-cart"/>" title="cart" id="head_cart">Your Cart (0)</a></li>
					</ul>
				</div>
				<div class="clear"></div>
			</div>
...
<div class="posts-wrap" id="page">
	<div class="post">
		<div class="entry-content" id="page-content">
			<h2 class="post_title">Your Shopping Cart</h2>
			...
			<form id="CartForm" action="#" method="post">
				<table id="viewCartTable">
					...
					<tbody>
						<s:iterator value="#session.clothess">
							<tr>
							<td>
								<a class="product_url" href="<s:url value="product-single" />"><s:property value="name" /> (<s:property value="gender"/>,  <s:property value="size" />)</a>
							</td>
							<td>
								<s:set var="quantityValue" value="quantity#name"></s:set>
								<input id="quantityValue" type="text" name="quantity[0]" value="0" class="itemQuantity" onblur="getTotal();"/>
								<a href="#" title="Remove item from cart">
									<img src="<s:url value="/assets/store/images/remove-item.png" />" alt="Remove Item" />
								</a>
							</td>
							<s:set var="priceValue" value="priceId#name"></s:set>
							<td id="priceValue">$<s:property value="price" /></td>
							
							<s:set var="totalValue" value="total#name"></s:set>
							<td id="totalValue"">$10.00</td>
						</tr>
						</s:iterator>
						<tr class="subtotal">
							<td>&nbsp;</td>
							<td>
								<input type="submit" name="updateCart" value="Update Total" class="UpdateTotalButton ButtonSecondary" />
							</td>
							<td class="alignRight strong">Subtotal:</td>
							<td class="strong">$30.00</td>
						</tr>
						<tr class="shipping">
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td class="alignRight strong">Shipping:</td>
							<td class="strong">$10.00</td>
						</tr>
						<tr class="total">
							<td class="alignRight" colspan="2">
								<p class="haveCoupon">Do you have a coupon?</p>
								<div id="couponCode"><input type="text" name="couponCode" value="" /></div>
								<div id="updateCart">
									<input type="submit" name="updateCart" value="Apply Coupon" class="ApplyCouponButton ButtonSecondary" />
								</div>
							</td>
							<td class="alignRight strong CartTotalLabel">Total:</td>
							<td class="strong">$40.00</td>
						</tr>
					</tbody>
				</table>
			</form>
			<div id="viewCartNav">
				<div id="continueShopping">
					<a href="product-single.html" class="ButtonSecondary CartContinueShopping" title="Continue Shopping">Continue Shopping</a>
				</div>
				<div id="checkoutShopping">
					<a id="CheckoutButton" href="page-checkout.html" class="ButtonPrimary" title="Continue to Checkout">Checkout</a>
					<div class="clear"></div>
				</div>
			</div>
			<div class="clear"></div>
...
<div id="sidebar">
	<div class="widget">
		<h4 class="widgettitle"><span id="WidgetCartTitle">Your Shopping Cart</span></h4>
		<div id="WidgetCartContents">
			<a id="WidgetCartLink" href="page-cart.html">
				<span id="WidgetCartCount">3</span>
				<span id="WidgetCartCountText"> items</span>
				<span id="WidgetCartCountDash">&ndash;</span>
				<span id="WidgetCartPrice">$30.00</span>
			</a>
			<div class="clear"></div>
			<a id="WidgetViewCart" href="page-cart.html">View Cart</a>
			<span id="WidgetLinkSeparator"> | </span>
			<a id="WidgetCheckout" href="page-checkout.html">Check out</a>
		</div>
		<p id="WidgetCartEmpty" style="display:none;">Your cart is empty.</p>
	</div>
	<div class="widget">
		<h4 class="widgettitle">Newest Shirts</h4>
		<div id="recent_products">
			<a href="product-single.html" title="Happiness Junky">
				<img width="46" height="46" src="<s:url value="/assets/store/images/demo/happiness-junky-46x46.png" />" alt="Happiness Junky" title="Happiness Junky" />
			</a>
			<a href="product-single.html" title="Hannibal The Great">
				<img width="46" height="46" src="<s:url value="/assets/store/images/demo/hannibal-the-great-impossible-possibility-46x46.png"/>" alt="Hannibal The Great" title="Impossible Possibility" />
			</a>
			<a href="product-single.html" title="Animus In Primis">
				<img width="46" height="46" src="<s:url value="/assets/store/images/demo/animus-in-primis-46x46.png"/>" alt="Animus In Primis" title="Courage Above All" />
			</a>
			<a href="product-single.html" title="Cinderella Boxing">
				<img width="46" height="46" src="<s:url value="/assets/store/images/demo/cinderellas-boxing-new-gray-e1323896628571-46x46.png"/>" alt="Cinderella Boxing" title="Cinderella&#039;s Boxing" />
			</a>
			<a href="product-single.html" title="Greatness of Mind">
				<img width="46" height="46" src="<s:url value="/assets/store/images/demo/GREATNESS-OF-MIND-original-e1323896931249-46x46.png"/>" alt="Greatness of Mind" title="Greatness of Mind" />
			</a>
			<a href="product-single.html" title="Fight For What You Love">
				<img width="46" height="46" src="<s:url value="/assets/store/images/demo/cherub-46x46.png"/>" alt="Fight For What You Love" title="cherub" />
			</a>
			<div class="clear"></div>
		</div>
	</div>
	<div class="widget">
		...
		<div class="textwidget">This is a simple text widget. You can put whatever you want to in here and make it look cool. <a href="#">Here's a link</a>. And then here's some lorem ipsum dolor sit amet, consectetuer adipiscing elit.
		</div>
	</div>
	<div class="widget">
		<h4 class="widgettitle">Categories</h4>
		<ul>
			<li><a href="product-archive.html" title="View all posts filed under General">General</a></li>
			<li><a href="product-archive.html" title="View all posts filed under Patterns">Patterns</a></li>
			<li><a href="product-archive.html" title="View all posts filed under Products">Products</a></li>
			<li><a href="product-archive.html" title="View all posts filed under Screenprinting">Screenprinting</a></li>
		</ul>
	</div>
...
J(document).ready(function(){
				var nameof = J("#nameOf").val().trim();

				console.log(nameof);
	
				J("#quantityValue").blur(function(){
					
					console.log("===onblur event====");
					J("#totalValue").val(J("#priceValue").text().indexOf * J("#quantityValue").val());	
J("#totalValue").text('some text').append('Some text')
...
<!-- Mirrored from themes.designcrumbs.com/html/stored/page-cart.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Jan 2017 15:01:29 GMT -->
</html>