...
<link href='http://fonts.googleapis.com/css?family=Crete+Round' rel='stylesheet' type='text/css'>
<link href='<s:url value="/assets/theme1/css/bootstrap.css"/>' rel="stylesheet">
<link href="<s:url value="/assets/theme1/css/bootstrap-responsive.css"/>" rel="stylesheet">
<link href="<s:url value="/assets/theme1/css/style.css"/>" rel="stylesheet">
<link href="<s:url value="/assets/theme1/css/flexslider.css"/>" type="text/css" media="screen" rel="stylesheet"  />
<link href="<s:url value="/assets/theme1/css/jquery.fancybox.css"/>" rel="stylesheet">
<link href="<s:url value="/assets/theme1/css/cloud-zoom.css"/>" rel="stylesheet">
<link href="<s:url value="/assets/theme1/css/portfolio.css"/>" rel="stylesheet">
...
<!--[if lt IE 9]>
    ...
    <![endif]-->
<!-- fav -->
<link rel="shortcut icon" href="<s:url value="assets/theme1/ico/favicon.ico"/>">
</head>
<body>
<!-- Header Start -->
<header>
    <div class="headerstrip">
        <div class="container">
            <div class="row">
                <div class="col-lg-12"> <a href="index.html" class="logo pull-left"><img src="<s:url value="/assets/theme1/img/logo.png"/>" alt="SimpleOne" title="SimpleOne"></a> 
                    <!-- Top Nav Start -->
                    <div class="pull-left">
                        ...
                        <ul class="dropdown-menu topcartopen ">
                            <li>
                                <table>
                                    <tbody>
                                        <tr>
                                            <td class="image"><a href="product.html"><img width="50" height="50" src="<s:url value="assets/theme1/img/prodcut-40x40.jpg" />" alt="product" title="product"></a></td>
                ...
                <ul class="nav-pills categorymenu">
                    ...
                    <li><a href="product.html">Products</a>
                        <div>
                            ...
                            <ul>
                                <li><img style="display:block" src="<s:url value="/assets/theme1/img/proudctbanner.jpg" />" alt="" title="" > </li>
                            </ul>
                        </div>
                    </li>
...
<div id="maincontainer">
  ...
  <section class="slider">
    <div class="container">
      <div class="flexslider" id="mainslider">
        <ul class="slides">
          <li>
            <img src="<s:url value="assets/theme1/img/banner1.jpg" />" alt="" />
          </li>
          <li>
            <img src="<s:url value="/assets/theme1/img/banner2.jpg"/>" alt="" />
          </li>
          <li>
            <img src="<s:url value="/assets/theme1/img/banner1.jpg" />" alt="" />
          </li>
    ...
    <div class="container">
      ...
      <ul class="thumbnails">
        ...
        <li class="col-lg-3  col-sm-6">
          <a class="prdocutname" href="product.html">Product Name Here</a>
          <div class="thumbnail">
            <a href="#"><img alt="" src="<s:url value="/assets/theme1/img/product2.jpg"/>"></a>
            <div class="shortlinks">
              <a class="details" href="#">DETAILS</a>
              <a class="wishlist" href="#">WISHLIST</a>
              <a class="compare" href="#">COMPARE</a>
        ...
        <li class="col-lg-3  col-sm-6">
          ...
          <div class="thumbnail">
            ...
            <a href="#"><img alt="" src="<s:url value="/assets/theme1/img/product1.jpg" />"></a>
            <div class="shortlinks">
              <a class="details" href="#">DETAILS</a>
              <a class="wishlist" href="#">WISHLIST</a>
              <a class="compare" href="#">COMPARE</a>
    ...
    <div class="container">
      ...
      <ul class="thumbnails">
        <li class="col-lg-3 col-sm-6">
          <a class="prdocutname" href="product.html">Product Name Here</a>
          <div class="thumbnail">
            <a href="#"><img alt="" src="<s:url value="/assets/theme1/img/product1a.jpg" />"></a>
            <div class="shortlinks">
              <a class="details" href="#">DETAILS</a>
              <a class="wishlist" href="#">WISHLIST</a>
              <a class="compare" href="#">COMPARE</a>
        ...
        <li class="col-lg-3  col-sm-6">
          <a class="prdocutname" href="product.html">Product Name Here</a>
          <div class="thumbnail">
            <a href="#"><img alt="" src="<s:url value="/assets/theme1/img/product2a.jpg" />"></a>
            <div class="shortlinks">
              <a class="details" href="#">DETAILS</a>
              <a class="wishlist" href="#">WISHLIST</a>
              <a class="compare" href="#">COMPARE</a>
  ...
  <section class="container smbanner">
    <div class="row">
      <div class="col-lg-3 col-sm-6"><a href="#"><img src="<s:url value="/assets/theme1/img/smbanner.jpg" />" alt="" title=""></a>
      </div>
      <div class="col-lg-3 col-sm-6"><a href="#"><img src="<s:url value="/assets/theme1/img/smbanner.jpg" />" alt="" title=""></a>
      </div>
      <div class="col-lg-3 col-sm-6"><a href="#"><img src="<s:url value="/assets/theme1/img/smbanner.jpg" />" alt="" title=""></a>
  ...
  <section id="popularbrands" class="container mt40">
    ...
    <div class="brandcarousalrelative">
      <ul id="brandcarousal">
        <li><img src="<s:url value="/assets/theme1/img/brand1.jpg" />" alt="" title=""/></li>
        <li><img src="<s:url value="/assets/theme1/img/brand2.jpg" />" alt="" title=""/></li>
        <li><img src="<s:url value="/assets/theme1/img/brand3.jpg" />" alt="" title=""/></li>
        <li><img src="<s:url value="/assets/theme1/img/brand4.jpg" />" alt="" title=""/></li>
        <li><img src="<s:url value="/assets/theme1/img/brand1.jpg" />" alt="" title=""/></li>
        <li><img src="<s:url value="/assets/theme1/img/brand2.jpg" />" alt="" title=""/></li>
        <li><img src="<s:url value="/assets/theme1/img/brand3.jpg" />" alt="" title=""/></li>
        <li><img src="<s:url value="/assets/theme1/img/brand4.jpg" />" alt="" title=""/></li>
...
<script src="<s:url value="/assets/theme1/js/jquery.js" />"></script> 
<script src="<s:url value="/assets/theme1/js/bootstrap.js" />"></script> 
<script src="<s:url value="/assets/theme1/js/respond.min.js" />"></script> 
<script src="<s:url value="/assets/theme1/js/application.js" />"></script> 
<script src="<s:url value="/assets/theme1/js/bootstrap-tooltip.js" />"></script> 
<script defer src="<s:url value="/assets/theme1/js/jquery.fancybox.js" />"></script> 
<script defer src="<s:url value="/assets/theme1/js/jquery.flexslider.js" />"></script> 
<script type="text/javascript" src="<s:url value="/assets/theme1/js/jquery.tweet.js" />"></script> 
<script  src="<s:url value="/assets/theme1/js/cloud-zoom.1.0.2.js" />"></script> 
<script  type="text/javascript" src="<s:url value="/assets/theme1/js/jquery.validate.js" />"></script> 
<script type="text/javascript"  src="<s:url value="/assets/theme1/js/jquery.carouFredSel-6.1.0-packed.js" />"></script> 
<script type="text/javascript"  src="<s:url value="/assets/theme1/js/jquery.mousewheel.min.js" />"></script> 
<script type="text/javascript"  src="<s:url value="/assets/theme1/js/jquery.touchSwipe.min.js" />"></script> 
<script type="text/javascript"  src="<s:url value="/assets/theme1/js/jquery.ba-throttle-debounce.min.js" />"></script> 
<script src="<s:url value="/assets/theme1/js/jquery.isotope.min.js" />"></script> 
<script defer src="<s:url value="/assets/theme1/js/custom.js" />"></script>
</body>
</html>