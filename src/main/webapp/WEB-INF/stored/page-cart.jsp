...
<body class="scheme_light button_blue content_left">
		...
		<div class="container">
			...
			<div id="cart_links">
				<ul>
					...
					<li><a href="<s:url value="page-cart"/>" title="cart"
					...
					<div class="entry-content" id="page-content">
						...
						<form id="CartForm" action="#" method="post">
							<table id="viewCartTable">
								...
								<tbody>
									<s:iterator value="#session.clothess" var="c">
										<tr>
											<td><a class="product_url"
												href="<s:url value="product-single" />"><s:property
														value="#c.name" /> (<s:property value="#c.gender" />, <s:property
														value="#c.size" />)</a></td>
											<td>
												<input id="quantity<s:property value="#c.id" />" type="text" name="quantity[0]"
												value="0" class="itemQuantity" /> <a href="#"
												title="Remove item from cart"> <img
													src="<s:url value="/assets/store/images/remove-item.png" />"
													alt="Remove Item" />
											</a></td>
											
											<td id="price<s:property value="#c.id" />">$<s:property value="#c.price" /></td>
											
											<input type="hidden" value="<s:property value="#c.id" />" id="idcode"/>
											<td id="total<s:property value="#c.id" />">$00.00</td>
										</tr>
									</s:iterator>
									<tr class="subtotal">
										<td>&nbsp;</td>
										<td><input type="submit" name="updateCart"
											value="Update Total"
											class="UpdateTotalButton ButtonSecondary" /></td>
									...
									<tr class="total">
										<td class="alignRight" colspan="2">
											...
											<div id="updateCart">
												<input type="submit" name="updateCart" value="Apply Coupon"
													class="ApplyCouponButton ButtonSecondary" />
											</div>
										</td>
						...
						<div id="viewCartNav">
							<div id="continueShopping">
								<a href="product-single.html"
									class="ButtonSecondary CartContinueShopping"
									title="Continue Shopping">Continue Shopping</a>
							</div>
							<div id="checkoutShopping">
								<a id="CheckoutButton" href="page-checkout.html"
									class="ButtonPrimary" title="Continue to Checkout">Checkout</a>
								<div class="clear"></div>
							</div>
						</div>
						<div class="clear"></div>
			...
			<div id="sidebar">
				<div class="widget">
					<h4 class="widgettitle">
						<span id="WidgetCartTitle">Your Shopping Cart</span>
					</h4>
					<div id="WidgetCartContents">
						<a id="WidgetCartLink" href="page-cart.html"> <span
							id="WidgetCartCount">3</span> <span id="WidgetCartCountText">
								items</span> <span id="WidgetCartCountDash">&ndash;</span> <span
							id="WidgetCartPrice">$30.00</span>
						</a>
						<div class="clear"></div>
						<a id="WidgetViewCart" href="page-cart.html">View Cart</a> <span
							id="WidgetLinkSeparator"> | </span> <a id="WidgetCheckout"
							href="page-checkout.html">Check out</a>
					</div>
					<p id="WidgetCartEmpty" style="display: none;">Your cart is
						empty.</p>
				</div>
				<div class="widget">
					<h4 class="widgettitle">Newest Shirts</h4>
					<div id="recent_products">
						<a href="product-single.html" title="Happiness Junky"> <img
							width="46" height="46"
							src="<s:url value="/assets/store/images/demo/happiness-junky-46x46.png" />"
							alt="Happiness Junky" title="Happiness Junky" />
						</a> <a href="product-single.html" title="Hannibal The Great"> <img
							width="46" height="46"
							src="<s:url value="/assets/store/images/demo/hannibal-the-great-impossible-possibility-46x46.png"/>"
							alt="Hannibal The Great" title="Impossible Possibility" />
						</a> <a href="product-single.html" title="Animus In Primis"> <img
							width="46" height="46"
							src="<s:url value="/assets/store/images/demo/animus-in-primis-46x46.png"/>"
							alt="Animus In Primis" title="Courage Above All" />
						</a> <a href="product-single.html" title="Cinderella Boxing"> <img
							width="46" height="46"
							src="<s:url value="/assets/store/images/demo/cinderellas-boxing-new-gray-e1323896628571-46x46.png"/>"
							alt="Cinderella Boxing" title="Cinderella&#039;s Boxing" />
						</a> <a href="product-single.html" title="Greatness of Mind"> <img
							width="46" height="46"
							src="<s:url value="/assets/store/images/demo/GREATNESS-OF-MIND-original-e1323896931249-46x46.png"/>"
							alt="Greatness of Mind" title="Greatness of Mind" />
						</a> <a href="product-single.html" title="Fight For What You Love">
							<img width="46" height="46"
							src="<s:url value="/assets/store/images/demo/cherub-46x46.png"/>"
							alt="Fight For What You Love" title="cherub" />
						</a>
						<div class="clear"></div>
					</div>
				</div>
				<div class="widget">
					...
					<div class="textwidget">
						This is a simple text widget. You can put whatever you want to in
						here and make it look cool. <a href="#">Here's a link</a>. And
						then here's some lorem ipsum dolor sit amet, consectetuer
						adipiscing elit.
					</div>
				</div>
				<div class="widget">
					...
					<ul>
						<li><a href="product-archive.html"
							title="View all posts filed under General">General</a></li>
						<li><a href="product-archive.html"
							title="View all posts filed under Patterns">Patterns</a></li>
						<li><a href="product-archive.html"
							title="View all posts filed under Products">Products</a></li>
						<li><a href="product-archive.html"
							title="View all posts filed under Screenprinting">Screenprinting</a></li>
					</ul>
				</div>
			</div>
			<div class="clear"></div>
	...
	<script type="text/javascript">
		...
		J(document)
				.ready(
						function() {
							var idcode = J("#idcode").val().trim();
							console.log(idcode);
							var paramQuantity = "#quantity" + idcode;
							console.log(paramQuantity);
							J(paramQuantity).blur(
									function() {
										console.log("===onblur event====");
										var paramTotal = "#total"+idcode;
										J(paramTotal).text("$").append(
												J("#price"+idcode).text()
														.substring(1)
														* J("#quantity"+idcode)
																.val()).append(
